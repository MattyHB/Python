...
class AnimatedFlyingObject(FlyingObject):
    def __init__(self, frames: list, x: int, y: int, speed: int, heading: int):
        super().__init__(frames[0], x, y, speed, heading)
        self.frames = frames
        self.curFrame = 0
...
if __name__ == "__main__":
    ...
    cloudImage = loadImage("george.jpeg")
    wolfFrames = loadAnimatedGif("georgeballoon.gif")
    flamingoFrames = loadAnimatedGif("georgejump.gif")
